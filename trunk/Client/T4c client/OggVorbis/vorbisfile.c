 ...
 ********************************************************************
 ...
 last mod: $Id: vorbisfile.c 16037 2009-05-26 21:10:58Z xiphmont $
...
int ov_pcm_seek_page(OggVorbis_File *vf,ogg_int64_t pos){
  ...
  /* verify result */ //PATCHED Chaotikmind
...
int ov_crosslap(OggVorbis_File *vf1, OggVorbis_File *vf2){
  ...
  lappcm=_alloca(sizeof(*lappcm)*vi1->channels);
  ...
  for(i=0;i<vi1->channels;i++)
    lappcm[i]=_alloca(sizeof(**lappcm)*n1);
...
static int _ov_64_seek_lap(OggVorbis_File *vf,ogg_int64_t pos,
  ...
  lappcm=_alloca(sizeof(*lappcm)*ch1);
  for(i=0;i<ch1;i++)
    lappcm[i]=_alloca(sizeof(**lappcm)*n1);
