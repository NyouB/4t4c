...
TLightningManager::TLightningManager(void):LightPool(13)
{
	...
	Fst.Read(LightTables[LightLoc_OpenAir],1440*sizeof(unsigned long));
};
...
void TLightningManager::SetLocation(TLightLocation NewLoc)
{
	Location=NewLoc;
...
void TLightningManager::Render(float DeltaTime)
{
	...
	GfxCore.DrawSprite(0.0f,0.0f,0.1f,GfxCore.ScreenWidth()-1,GfxCore.ScreenHeight()-1,GeneralLightColor,GfxCore.GetBackBufferTexture());
/*
